    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            if TranslationSet(transcript) == 0:
                break
            elif TranslationSet(transcript) == 1:
                translation_en_to_ko.main()
            elif TranslationSet(transcript) == 2:
                translation_ko_to_en.main()
            elif TranslationSet(transcript) == 3:
                translation_en_to_ja.main()
            elif TranslationSet(transcript) == 4:
                translation_en_to_cn.main()
            elif TranslationSet(transcript) == 5:
                translation_en_to_fr.main()
            elif TranslationSet(transcript) == 6:
                translation_en_to_sp.main()
            elif TranslationSet(transcript) == 7:
                translation_en_to_de.main()
            elif TranslationSet(transcript) == 8:
                translation_en_to_ru.main()
            elif TranslationSet(transcript) == 9:
                translation_en_to_pt.main()
            elif TranslationSet(transcript) == 10:
                translation_en_to_nl.main()
            elif TranslationSet(transcript) == 11:
